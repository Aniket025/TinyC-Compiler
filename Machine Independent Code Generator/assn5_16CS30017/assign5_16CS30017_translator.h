...
// Defining size for each variable type as for symbol table 
#define CHAR_SIZE 		1
#define INT_SIZE  		4
...
////////////////////////////////////////////////// global variables used in the translator.cxx file
...
public:
	...
	quad (string result, string arg1, string op = "EQUAL", string arg2 = "");			//constructor for strings
	quad (string result, int arg1, string op = "EQUAL", string arg2 = "");				//constructor for int
	quad (string result, float arg1, string op = "EQUAL", string arg2 = "");			//constructor for float
};
...
void emit(string op, string result, string arg1="", string arg2 = "");    //emits for adding quads to quadArray (arg1 is string )
