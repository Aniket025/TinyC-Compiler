#include "assign5_16CS30017_translator.h"
#include <sstream>
...
//Backpatching lists and addresses
...
int  main (int argc, char* argv[]){
	globalTable = new symtable("Global");	//New symbol table created i.e. Global Symbol table
	table = globalTable;			//Current symbol table set as global symbol table
	yyparse();				//Start parse
	globalTable->update();			//Update global table
	globalTable->print();			//Print global symbol table
	q.print();				//Print quad array
};
